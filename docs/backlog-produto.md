...
- [ ] O fluxo pode ser interrompido e retomado (sessão temporária) _(não implementado)_
- [x] O cliente pode usar o formulário multi-etapa (3 etapas + tela de sucesso)
- [x] Chatbot guiado disponível como alternativa — **[CONCLUÍDO]** `ChatbotEncerramento` com 10 passos, toggle com formulário, modo padrão
- [x] Todas as etapas têm mensagens claras em linguagem simples
- Status: ✅ Concluído (formulário ✅ | chatbot ✅ | toggle ✅)
