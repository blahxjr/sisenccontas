  ...
  async gerarTermoEncerramento(dados: DadosTermoEncerramento): Promise<Buffer> {
    ...
    const verificarEspaco = (alturaNeeded: number): void => {
      if (y - alturaNeeded < 75) {
        ...
        page.drawText(
          "BANCO DO NORDESTE DO BRASIL S/A — TERMO DE ENCERRAMENTO (continuação)",
          {
            x: 40,
            y: PAGE_H - 19,
            font: fontBold,
    ...
    page.drawText("2.1  Número com DV:", {
      x: MARGIN_L,
      y,
      font: fontBold,
      size: 8,
    ...
    page.drawText("2.2  Nome do(s) titular(es):", {
      x: 250,
      y,
      font: fontBold,
      size: 8,
    ...
    y -= 13;
    page.drawText(dados.numeroConta, {
      x: MARGIN_L,
      y,
      font: fontRegular,
      size: 9,
    ...
    page.drawText(dados.titularNome, {
      x: 250,
      y,
      font: fontRegular,
      size: 9,
    ...
    y -= 13;
    page.drawText("(Nome/assinatura do titular)", {
      x: MARGIN_L,
      y,
      font: fontRegular,
      size: 8,
